...
function displayTime2() {
    ...
    var div = document.getElementById("new-year"); //обращаемся к пустому диву «часы»

    var sDate = new Date(2019,10,13,14,00); //объявление переменной, до какой даты считать
...
//-66734207489ms/(минуты*секунды*милисекунды)%24(убираем подсчитанные дни.) = 14, и нихуя не понятно, почему получилось это 14
 ...
 //запуск скрипта после полной прогрузки страницы
window.onload = displayTime; //запуск скрипта после полной прогрузки страницы
